...
if ($ADMIN->fulltree) {
    ...
    if (!during_initial_install()) {
        ...
        $settings->add(new admin_setting_configcheckbox('enrol_meta/manageuishowshortname',
            get_string('manageuishowshortname', 'enrol_meta'),
            get_string('manageuishowshortname_desc', 'enrol_meta'), 1));
