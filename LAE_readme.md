# [Moodle Liberal Arts Edition v2.6.10-LAE6.0.8]
...
Moodle 2.6.10+LAE6.0.8 consists of the core Moodle 2.6.10 release plus a number of CLAMP-developed features and bug fixes.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v2.6.10-LAE6.0.8
    git checkout -b v2.6.10-LAE6.0.8

By default this is the "Package" version which includes the contributed modules. If you just want the core version of the LAE checkout the v2.6.10-LAE6.0.8-base tag instead.

CLAMP maintains two branches for each major version:

* LAE_26_STABLE contains the core code only
* LAE_26_PACKAGE includes the contributed modules
