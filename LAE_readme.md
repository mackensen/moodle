# [Moodle Liberal Arts Edition v2.8.7-LAE8.0.5]
...
Moodle 2.8.7+LAE8.0.5 consists of the core Moodle 2.8.7 release plus a number of CLAMP-developed features and bug fixes.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v2.8.7-LAE8.0.5
    git checkout -b v2.8.7-LAE8.0.5

By default this is the "Package" version which includes the contributed modules. If you just want the core version of the LAE checkout the v2.8.7-LAE8.0.5-base tag instead.
