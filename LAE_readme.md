# [Moodle Liberal Arts Edition v2.4.10-LAE4.1.4]
...
Moodle 2.4.10+LAE4.1.4 consists of the core Moodle 2.4.10 release plus a number of CLAMP-developed features and bug fixes.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v2.4.10-LAE4.1.4
    git checkout -b v2.4.10-LAE4.1.4

By default this is the "Package" version which includes the contributed modules. If you just want the core version of the LAE checkout the v2.4.10-LAE4.1.4-base tag instead.
