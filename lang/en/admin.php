...
$string['configsupportemail:public'] = 'If set, this email address will be published in the "Contact site support" popover instead of the primary support email.';
...
$string['supportemail:public'] = 'Public support email';
