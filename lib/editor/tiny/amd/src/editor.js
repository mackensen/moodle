...
const getStandardConfig = (target, tinyMCE, options, plugins) => {
    ...
    const config = Object.assign({}, getDefaultConfiguration(), {
        ...
        // Disable the Alt+0 shortcut.
        // It conflicts with the Hebrew keyboard layout
        // which uses Alt+0 to print the Shva character.
        // See MDL-85739 for further information.
        // eslint-disable-next-line camelcase
